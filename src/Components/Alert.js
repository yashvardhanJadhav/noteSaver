    ...
    return (
        <>
            <header className="sticky top-16 z-50">
                ...
                {
                    props.alertData.type === 'green' ? (
                        <>
                            <div id="alert-border-3" className="flex p-4 mb-4 bg-green-100 border-t-4 border-green-500 dark:bg-green-200" role="alert">
